package com.ddfeiyu.dddbootgateway.common.system.util;
...
import com.ddfeiyu.dddbootgateway.common.system.vo.SysUserCacheInfo;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws DDDBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws DDDBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (ConvertUtils.isEmpty(username)) {
			throw new DDDBootException("未获取到用户");
		}
		return username;
	}
