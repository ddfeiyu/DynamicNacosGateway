package com.ddfeiyu.dddbootgateway.common.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.ddfeiyu.dddbootgateway.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
