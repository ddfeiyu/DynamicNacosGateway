...
import com.ddfeiyu.dddbootgateway.common.enums.SentinelErrorInfoEnum;
...
@Slf4j
public class DDDBootExceptionHandler {

	/**
	 * 处理自定义异常
	 */
	@ExceptionHandler(DDDBootException.class)
	public Result<?> handleJeecgBootException(DDDBootException e){
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(DDDBoot401Exception.class)
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public Result<?> handleJeecgBoot401Exception(DDDBoot401Exception e){
		log.error(e.getMessage(), e);
